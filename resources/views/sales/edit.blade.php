<x-app-layout>
                    ...
                    <form action="{{ route('sales.update', $sale->id) }}" method="POST" id="sales-form">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <input type="hidden" name="sales_date" value="{{ $sale->sales_date->format('Y-m-d') }}">
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <table class="w-full table-auto text-sm text-left">
                                ...
                                <tbody id="items-body">
                                    @foreach(old('items', $sale->items->toArray()) as $i => $item)
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            let rowIndex = {{ count(old('items', $sale->items)) }};
