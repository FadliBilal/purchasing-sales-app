                    ...
                    <tbody>
                        @forelse($sales as $sale)
                            <tr class="border-b border-gray-700 hover:bg-gray-700/30">
                                <td class="py-2 px-4">{{ $sale->sales_date->format('Y-m-d') }}</td>
                                <td class="py-2 px-4">{{ $sale->customer->name_customer }}</td>
                                <td class="py-2 px-4">Rp {{ number_format($sale->items->sum(fn($i)=> $i->quantity * $i->price),0,',','.') }}</td>
                                <td class="py-2 px-4">
